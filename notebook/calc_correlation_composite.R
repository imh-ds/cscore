#' DELETE - Calculate Correlation-Weighted Composite Score
#'
#' @description
#'
#' Create a composite score by specifying the indicators that go into
#' the composite variable. The composite score is calculated as the
#' correlation-weighted mean of the indicators.
#'
#' See documentation for \code{?correlation_score} for information on the
...
#' calc_correlation_composite(data = grit,
#'                            var = extraversion)
#' 
...
#'
#' @export
calc_correlation_composite <- function(data,
                                       var,
                                       name = NULL,
                                       digits = 3,
