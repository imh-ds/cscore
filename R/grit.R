#' Grit Data
#'
#' @description This example data contains 500 responses from people completing
#'   the Big 5 personality inventory (John & Srivastava, 1999) and the Grit
#'   Scale (Duckworth et al., 2007) from
#'   \href{https://openpsychometrics.org/_rawdata/}{OpenPsychoMetrics}.
#'
#' @name grit
#'
#' @docType data
...
#'
#' @references Duckworth, A.L., Peterson, C., Matthews, M.D., & Kelly, D.R.
