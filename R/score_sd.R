...
#' The reported indicator loadings \eqn{\lambda_j} are standardized loadings on
#' a single common factor, estimated by a minimum-residual one-factor solution
#' of the indicators' pairwise-complete correlation matrix
...
#'          composite_list = composite_list)
#'
#' # Calculate SD-weighted composite scores, reliability, & validity
